...
import { Button, Table, Input, Row, Col, Space, Divider, Drawer } from 'antd';
import './style.css';
                ...
                <div className="form_">
                    ...
                    <Row gutter={16} style={style}>
                        ...
                        <Col className="gutter-row" style={{ minWidth: '150' }}>
                            ...
                            <div >
                                <Button type="primary"
                                    onClick={() => this.props.searchDispatch(this.state.dataSearch)}>
                                    Tìm kiếm
                                </Button>
                            </div>
                        </Col>
                    ...
                    <Row gutter={16} style={style}>
                        ...
                        <Col className="gutter-row" style={{ minWidth: '150' }}>
                            ...
                            <div ><Input name='number' className="input_"
                                ...
                                onChange={(e) => this.setState({
                                    dataUpdate: { ...this.state.dataUpdate, number: e.target.value }
                                })}
                            /></div>
                        </Col>
                        <Col className="gutter-row" style={{ minWidth: '150' }}>
                            ...
                            <div ><Input name='class' className="input_"
                                ...
                                onChange={(e) => this.setState({
                                    dataUpdate: { ...this.state.dataUpdate, class: e.target.value }
                                })}
                            /></div>
                        </Col>
                        <Col className="gutter-row" style={{ minWidth: '150' }}>
                    ...
                    <div className="main_table">
                        ...
                        <Table dataSource={listData} rowKey="id" >
                            ...
                            <Column title="Action" render={(item) => {
                                ...
                                return (
                                    <Space size="middle">
                                        <Button type="primary" onClick={() => this.update_f(item)}>view</Button>
